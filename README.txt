...
I used generative AI to help explain how to unpack a json for the backend to select specific attributes
and for the frontend to help to understand how the underlying code was structured.
